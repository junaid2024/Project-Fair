...
function Header({ insideDashboard }) {
  ...
  return (
    <Navbar expand="lg" style={{ backgroundColor: '#99ee90' }} className='position-fixed z-1 top-0 w-100 p-3 bg-black'>
      <Container>
        ...
        {
          insideDashboard &&
          <button style={{textDecoration:'none'}} className='btn btn-link text-danger fs-5 fw-bold text-capitalize' onClick={handleLogout}>
